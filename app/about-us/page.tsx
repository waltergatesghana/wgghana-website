...
const AboutUsPage = () => {
  ...
  return (
    <div id="about-us" className="min-h-screen bg-gray-50">
      {/* Hero Banner */}
      <div
        ...
        <div className="relative z-10 text-center px-6">
          ...
          >
            ...
            <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto">
              Innovating for a Smarter Digital Future- We Think, Create and Design.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 items-center">
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Waltergates Ghana Limited is a technology and innovation company focused on building digital ecosystems that transform how people work, connect, and thrive.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  From software development and digital marketplaces to AI-driven solutions and financial technology platforms, we provide the tools that fuel growth and digital transformation.
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 items-center">
              ...
              >
                <div className="bg-white rounded-lg p-8 shadow-lg">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To simplify complex systems through smart digital solutions that empower communities and organizations.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-8 shadow-lg">
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Our Vision</h3>
                  <p className="text-gray-700 leading-relaxed">
                    To be a leading African innovation hub bridging technology, finance, and human progress.
                  </p>
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                {['Innovation', 'Integrity', 'Excellence', 'Collaboration', 'Impact'].map((value, index) => (
                  ...
                  >
                    <div className="bg-blue-50 rounded-lg p-6 h-full flex items-center justify-center">
                      <p className="text-lg font-semibold text-[#2596be]">{value}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
